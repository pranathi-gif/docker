...
with open(output_path, 'w') as result_file:
    result_file.write(f"Word count for IF.txt: {word_count1}\n")
    result_file.write(f"Word count for AlwaysRememberUsThisWay.txt: {word_count2}\n")
    result_file.write(f"Grand total of words: {total_words}\n")
    result_file.write(f"Top 3 words in IF.txt: {top3_file1}\n")
    result_file.write(f"Top 3 words in AlwaysRememberUsThisWay.txt: {top3_file2}\n")
